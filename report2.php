    ...
    <div class="container">
      ...
      <form action="report2.php" method="post">
        <div class="form-group">
          <input type="text" name="college" class="form-control" placeholder="Enter College name">
        </div>
      ...
      $value1=$_POST['college'];
      echo "<table class='table table-bordered table-hover'> ";
      echo "<tr><th>PARTICIPANT</th><th>USN</th><th>EMAIL</th><th>PHONE</th></tr>";
      $query="select p_name,usn,email,phone from participant where college='$value1'group by usn order by p_name asc";
