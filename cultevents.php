...
<head>
    ...
    <style rel="stylesheet">
        ...
        #m2{
          background-image:linear-gradient(rgba(255,255,255,0.3),rgba(255,255,255,0.3)),  url("./img/solo.jpeg");
    ...
    function fillb(){
    $("#form14").val("Solo Dance");
  }
  function fillf(){
  $("#form14").val("Photography");
  }
  function fillba(){
  $("#form14").val("Painting");
  }
  ...
  function fillmi(){
  $("#form14").val("Vocal Solo");
  }
  function filltr(){
  $("#form14").val("Classical Dance");
  }
    </script>
</head>
  ...
  <br><br><br><br>
    <div class="container">
      <div class="row">
        ...
        $query="select event_name,no_of_mem,venue,date,time,reg_fee,prize,photo from event where cat_id=3";
